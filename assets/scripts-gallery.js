$(document).ready(function () {
  ...
  function blocksForHtml(a) {
    ...
    console.log('blocksforhtml func');
  }
...
90,90,90,180,360,450,540,180,360,360,630,180,360,270,270,270
    ...
    function makeBlocks(b) {
      ...
      for (i = 0; i < bData.length; i++) {
        var block = $(
          "<div class='0b" + i + " block-up data rotate " + b + "' style='transform: rotate(" + rData[i] + "deg);'></div>");
        $('.art-board').append(block);
        $('#block' + bData[i] + '').clone().appendTo(".0b" + i + "");
      }
      console.log('makeBlocks func');
    }, 1 );
    }
...
function makeBlocks2(b) {
  ...
  for (i = 0; i < bData.length; i++) {
    var block = $(
      "<div class='1b" + i + " block-up data rotate " + b + "' style='transform: rotate(" + rData[i] + "deg);'></div>");
